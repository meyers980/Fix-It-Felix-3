...
if (l5E790797_0)
{
	...
	if((l13CB2E55_0))
	{
		...
		if(!(felix.state == ps.DEAD))
		{
			...
			var l567C875E_0 = instance_place(x + 0, y + 1, o_solidswing);
			if ((l567C875E_0 > 0))
			{
				/// @DnDAction : YoYo Games.Common.Variable
				/// @DnDVersion : 1
...
/// @DnDArgument : "object" "o_solidswing"
/// @DnDSaveInfo : "object" "o_solidswing"
var l122D6FFF_0 = instance_place(x + 0, y + 2, o_solidswing);
if ((l122D6FFF_0 > 0))
{
	/// @DnDAction : YoYo Games.Common.Variable
	/// @DnDVersion : 1
...
if(moving == true)
{
	...
	/// @DnDHash : 7AD0385C
	/// @DnDParent : 712589D3
	/// @DnDArgument : "soundid" "sfx_swingmoving"
	/// @DnDArgument : "not" "1"
	/// @DnDSaveInfo : "soundid" "sfx_swingmoving"
	var l7AD0385C_0 = sfx_swingmoving;
	if (!audio_is_playing(l7AD0385C_0))
	{
		...
		/// @DnDArgument : "soundid" "sfx_swingmoving"
		/// @DnDSaveInfo : "soundid" "sfx_swingmoving"
		audio_play_sound(sfx_swingmoving, 0, 0);
	}
}
