...
Coin_3 = ini_read_real("Controls", "Coin_3", 55);
Coin_4 = ini_read_real("Controls", "Coin_4", 56);
Start_1 = ini_read_real("Controls", "Start_1", 49);
Start_2 = ini_read_real("Controls", "Start_2", 50);
Start_1B = ini_read_real("Controls", "Start_1B", 51);
Start_2B = ini_read_real("Controls", "Start_2B", 52);
...
//Coin 3
keyboard_set_map(Coin_3, ord("7"));
//Coin 4
keyboard_set_map(Coin_4, ord("8"));
//1 Start
keyboard_set_map(Start_1, ord("1"));
//2 Start
keyboard_set_map(Start_2, ord("2"));
//1 Start B
keyboard_set_map(Start_1B, ord("3"));
//2 Start B
keyboard_set_map(Start_2B, ord("4"));
//P1 Left
...
if global.screens = 1
	...
	surface_resize(application_surface, 512, 480);
	}
